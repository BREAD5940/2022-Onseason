...
public class INTAKE_FROM_LEFT_NO_CARGO_STOWED extends CommandBase {

    private final Superstructure superstructure;

    public INTAKE_FROM_LEFT_NO_CARGO_STOWED(Superstructure superstructure) {
        setName("INTAKE_FROM_LEFT_NO_CARGO_STOWED");
