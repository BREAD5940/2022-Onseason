...
public class SETUP_SHOT_ONE_ALLIANCE_CARGO extends CommandBase {

    private final Superstructure superstructure;

    public SETUP_SHOT_ONE_ALLIANCE_CARGO(Superstructure superstructure) {
        setName("SETUP_SHOT_ONE_ALLIANCE_CARGO");
    ...
    public void execute() {
        ...
        if (superstructure.flywheel.atSetpoint()&&superstructure.hood.atReference()) {
            ...
            CommandScheduler.getInstance().schedule(new SHOOT_ONE_ALLIANCE_CARGO(superstructure));
